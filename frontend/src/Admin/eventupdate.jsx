        ...
        {event ? (
          <form onSubmit={handleSubmit}>
            <div className="mb-3">
              ...
              <input type="text" className="form-control"  value={formData.eventName} onChange={handleChange} />
            </div>
            <div className="mb-3">
              <label htmlFor="eventDescription" className="form-label">Event Description</label>
              <textarea className="form-control"  value={formData.eventDescription} onChange={handleChange}></textarea>
            </div>

            <div className="mb-3">
              <label htmlFor="EventPrice" className="form-label">Event Start Date</label>
              <input type="date"  name="EventPrice" value={formData.eventStartDate} onChange={handleChange} />
            </div>
            <div className="mb-3">
